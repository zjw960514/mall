...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pay/css/car/base.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pay/css/car/home.css">
							...
							<div class="box-bd">
								<div class="clearfix xm-address-list" id="checkoutAddrList">
									...
									<div class="item use-new-addr"  id="J_useNewAddr" data-state="off">
										<span class="iconfont icon-add"><img src="${ctx}/static/pay/images/add_cart.png" /></span>
										使用新地址
									</div>
								</div>
